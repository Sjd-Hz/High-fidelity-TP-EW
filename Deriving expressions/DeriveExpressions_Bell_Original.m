% Original teleportation with Bell state without any protection through ADC
...
% Bell entangled state after passing through ADC 
rho_Bell_damp = (E0*rho_Bell*E0'+E1*rho_Bell*E1')/trace(E0*rho_Bell*E0'+E1*rho_Bell*E1');
